 ...
 * 残す: admins・blacklist・users・nicknames・publicProfiles・jobs・equipmentMaster（運用の設定・プロフィール・定期処理の記録・機器マスタ）。
...
const KEEP = ['admins', 'blacklist', 'users', 'nicknames', 'publicProfiles', 'jobs', 'equipmentMaster'];
