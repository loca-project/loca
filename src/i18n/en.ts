...
export const en: DeepPartial<Dictionary> = {
  ...
  myPosts: {
    ...
    tabMarkers: 'Posted videos ({count})',
    tabRequests: 'Shooting requests ({count})',
    ...
    withdrawSelected: 'Withdraw {count} selected',
    confirmDeleteMarkers: 'Delete {count} marker(s)? They are removed from the map and erased after 30 days.',
    confirmWithdraw: 'Withdraw your shooting requests at {count} spot(s)? The heat you used comes back.',
    deletedMarkers: 'Deleted {count} marker(s)',
    withdrawn: 'Withdrew {count} shooting request(s) (heat returned)',
  ...
  form: {
    ...
    search: 'Search',
    processing: 'Checking...',
    aiSearch: 'Also find similar videos with AI',
    aiSearchNote: 'Reads your words as tags (mood, season and more). Downloads about {mb} MB the first time; later searches use the copy saved on this device.',
    aiLoading: 'Preparing AI {pct}',
    aiReadAs: 'AI read as: {tags}',
    apply: 'Apply',
    mapTab: 'Map',
    markerTab: 'Marker',
  ...
  actions: {
    ...
    report: 'Report',
    copyLink: 'Copy link',
    linkCopied: 'Link to this map copied (with your filters and the selected marker).',
    linkCopyFailed: 'Could not copy the link. Share the URL in the address bar instead.',
