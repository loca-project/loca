...
export const en: DeepPartial<Dictionary> = {
  ...
  profile: {
    ...
    channelNote: 'Channel URL (youtube.com/@handle or /channel/UC…). Matching videos get "Poster\'s own channel (self-declared)" after the nightly update. Save empty to remove.',
    channelInvalid: 'Enter it as youtube.com/@handle or youtube.com/channel/UC…',
    channelSave: 'Save',
    channelSaved: 'Channel saved (the badge appears after the next nightly update)',
