...
export const ja = {
  ...
  form: {
    ...
    search: '検索',
    processing: '確認中...',
    aiSearch: 'AI で意味の近い動画も探す',
    aiSearchNote: '検索語をタグ（雰囲気・季節など）に読み替えて探します。初回だけ約 {mb} MB を読み込み、2 回目からは端末に保存したものを使います。',
    aiLoading: 'AI を準備中 {pct}',
    aiReadAs: 'AI の読み替え: {tags}',
    apply: '適用',
    mapTab: '地図',
    markerTab: 'マーカー',
  ...
  runtime: {
    ...
    mapUnavailable: '地図タイル（OpenStreetMap）を取得できませんでした。時間をおいて再読み込みしてください。',
