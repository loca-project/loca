...
export const adminJa = {
  ...
  equipment: {
    note: '分類ごとに、メーカー・シリーズ・モデルを直せます。投稿フォームには 3 時間以内（3 時間ごとの機器の同期。急ぐなら GitHub の Actions で「同期（機器マスタ）」を手動で実行）に入ります。分類の追加はコードの変更です。',
    category: '分類',
    editedMark: '（画面で変更）',
    ...
    save: '保存',
    discard: '変更を捨てる',
    confirmSave: '「{category}」をメーカー {makers}・シリーズ {series}・モデル {models} で保存しますか？3 時間以内に投稿フォームに入ります。',
    saved: '保存しました。3 時間以内に投稿フォームに入ります',
  },
